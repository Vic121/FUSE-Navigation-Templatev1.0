  <div class="card-media">
    ...
    <div class="card-media-object-container">
      <div class="card-media-object" style="background-image: url(https://cdn.eventcinemas.co.nz/cdn/resources/movies/12654/images/largeposter.jpg);"></div>
    ...
    <div class="card-media-body">
      ...
      <span class="card-media-body-heading">Robin Hood</span>
    ...
    <!-- media container -->
    <div class="card-media-object-container">
      <div class="card-media-object" style="background-image: url(https://cdn.eventcinemas.co.nz/cdn/resources/movies/12657/images/largeposter.jpg);"></div>
      <span class="card-media-object-tag subtle">Selling Fast</span>
      <ul class="card-media-object-social-list">
        <li>
          <img src="https://s10.postimg.cc/3rjjbzcvd/profile_f.jpg" class="">
    ...
    <div class="card-media-body">
      ...
      <span class="card-media-body-heading">Mortal Engines M</span>
      <div class="card-media-body-supporting-bottom">
        <span class="card-media-body-supporting-bottom-text subtle">Mezzanine, San Francisco, CA</span>
        <span class="card-media-body-supporting-bottom-text subtle u-float-right">Free &ndash; $30</span>
      </div>
    ...
    <!-- media container -->
    <div class="card-media-object-container">
      <div class="card-media-object" style="background-image: url(https://cdn.eventcinemas.co.nz/cdn/resources/movies/12968/images/largeposter.jpg);"></div>
      <span class="card-media-object-tag subtle">Selling Fast</span>
      <ul class="card-media-object-social-list">
        <li>
          <img src="https://s10.postimg.cc/3rjjbzcvd/profile_f.jpg" class="">
    ...
    <div class="card-media-body">
      ...
      <span class="card-media-body-heading">Tamil Version </span>
      <div class="card-media-body-supporting-bottom">
        <span class="card-media-body-supporting-bottom-text subtle">Mezzanine, San Francisco, CA</span>
        <span class="card-media-body-supporting-bottom-text subtle u-float-right">Free &ndash; $30</span>
      </div>
    ...
    <div class="card-media-body">
      ...
      <span class="card-media-body-heading">This Thing Called Life: A Celebration </span>
      <div class="card-media-body-supporting-bottom">
        <span class="card-media-body-supporting-bottom-text subtle">Mezzanine, San Francisco, CA</span>
        <span class="card-media-body-supporting-bottom-text subtle u-float-right">Free &ndash; $30</span>
      </div>
